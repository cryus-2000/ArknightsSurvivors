...
const ALLIES = {
	"sniper": {"name": "狙击干员", "en": "SNIPER", "desc": "远程单体射击，优先攻击精英和生命最高的敌人；命中使敌人流血", "up": "伤害 +35%，射速 +15%"},
	"caster": {"name": "术师干员", "en": "CASTER", "desc": "发射火球，命中后爆炸造成范围伤害", "up": "伤害 +35%，爆炸范围扩大"},
